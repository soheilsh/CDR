...
#    Dm1 = (a1 * Tatx1 + a2 * Tatx1**a3)
    Dm1 = (a2temp * Tatx1**a3 + a2ocean * (Mlox1 - mleq)**2 + a2atmos * (Matx1 - mateq)**2)     #the case with ocean acidification
    ...
    Matx2 = Matx1 + E1 * tstep/3.666 - sink1 + Outgas1/3.666 * tstep - xr1/3.666 * tstep

    Mlox2 = Mlox1 + sink1 - Outgas1/3.666 * tstep
...
def DICEalg( gamma1x, j ):
    ...
    bnds = 2 * T * [(0.0, 1)]
    bnds[0] = (0.039, 0.039)
    bnds[T:2 * T] = T * [(0.00, 1.00)]                                 #the case without CDR
    bnds[T] = (0.0, 0.0)
